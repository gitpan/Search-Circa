...
if (param('delete_url')) 
  ...
  {$indexor->URL->valid_all_non_valid($compte); print h3('Sites validés');}
elsif (param('delete_non_valid')) 
  {$indexor->URL->delete_all_non_valid($compte); print h3('Sites supprimés');}
